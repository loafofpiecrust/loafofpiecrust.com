  ...
  <Layout unpadded title="Resume">
    <div css={ResumeHeader}>
      <div css={[flex.row, flex.alignCenter]}>
        <header css={{ flex: 1 }}>
          <h1 css={{ margin: 0 }}>Taylor Snead</h1>
          <i css={{ margin: 0 }}>Available July &ndash; December 2020</i>
        </header>
        ...
        <div css={[flex.column, flex.alignEnd]}>
          ...
          <span>
            <a href={siteMeta.siteUrl}>loafofpiecrust.com</a>
          </span>
          <span>
            GitHub:{" "}
            <a href="https://github.com/loafofpiecrust">loafofpiecrust</a>
          </span>
        </div>
      </div>
    </div>
        ...
        <LeftSection>
          ...
          <div css={[flex.row, flex.justifyBetween, flex.wrap]}>
            <header css={{ flexGrow: 1 }}>
              <b>Northeastern University</b> &ndash; Boston, MA
              <br />
            </header>
